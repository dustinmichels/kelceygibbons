<script setup>
import { Linkedin, Mail, Menu, Microscope, Sparkles, Twitter } from 'lucide-vue-next'
import { ref } from 'vue'
  ...
  <div class="noise min-h-screen flex flex-col">
    ...
    >
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        <div @click="currentPage = 'home'" class="cursor-pointer">
        ...
        <div class="hidden md:flex gap-8 font-mono text-sm uppercase font-bold">
          <button
            ...
            :class="currentPage === 'home' ? 'text-[var(--sweet-peony)] underline' : ''"
          >
            Home
          </button>
          <button
            @click="currentPage = 'about'"
            :class="currentPage === 'about' ? 'text-[var(--sweet-peony)] underline' : ''"
          >
            About
          </button>
          <button
            @click="currentPage = 'writing'"
            :class="currentPage === 'writing' ? 'text-[var(--sweet-peony)] underline' : ''"
          >
            Poems & Stories
          </button>
        </div>
    ...
    <main class="flex-grow">
      <Transition name="fade" mode="out-in">
        <!-- Home Page -->
        <section v-if="currentPage === 'home'" key="home" class="p-6 md:p-12 max-w-7xl mx-auto">
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-7 space-y-8 relative z-10">
              ...
              <h2
                class="font-header text-5xl md:text-6xl lg:text-7xl font-black uppercase leading-[0.9] tracking-tighter"
              >
                Learning <br />
                is <br />
                <span class="text-[var(--sweet-peony)] underline decoration-sky-400"
                  >Liberating</span
                >
              </h2>
              <p
                class="text-xl md:text-2xl leading-relaxed max-w-xl italic text-[var(--blue-slate)]"
              >
                "I study American histories of technology by focusing on African American education
          ...
          >
            ...
            >
              ...
              Griot • Multimedia Storytelling • African American History • History of Technology •
              Digital Griot •
            </div>
          </div>
        </section>
        ...
        <section
          ...
          key="about"
          class="p-6 md:p-12 max-w-5xl mx-auto space-y-12"
        >
          <div class="flex flex-col md:flex-row gap-12">
            <div class="md:w-1/3">
              <div
                class="aspect-square bg-[var(--burnt-peach)] border-4 border-[var(--blue-slate)] relative duotone-hover"
              >
                <div
                  class="absolute inset-0 flex items-center justify-center text-white/30 font-mono text-xs text-center p-4"
                >
                  [ Image: Kelcey in the Lab ]
                </div>
                <div
                  class="absolute -top-4 -right-4 w-12 h-12 bg-[var(--sky-surge)] rounded-full border-2 border-[var(--blue-slate)] flex items-center justify-center text-white"
                >
            ...
            <div class="md:w-2/3 space-y-6">
              ...
              <div class="prose prose-lg text-[var(--blue-slate)] space-y-4">
                <p>
                  I am a PhD Candidate at MIT studying American histories of technology. My work
                  centers on the vibrant, often overlooked lineages of African American education
                  and professionalization.
                </p>
                <p>
                  By bridging the gap between archival research and multimedia storytelling, I seek
                  to reveal how technological systems have been both sites of exclusion and tools
                  for liberation.
                </p>
                <p>
                  I am a professional daydreamer, a multimedia storyteller, and I love my research
                  so, so much. I believe that understanding our technical past is a prerequisite for
                  building equitable futures.
                </p>
              </div>
              <div class="grid grid-cols-2 gap-4 pt-6">
                <div class="p-4 bg-[var(--sky-surge)]/10 border-l-4 border-[var(--sky-surge)]">
                  <h4 class="font-mono text-xs uppercase font-bold">Institutional</h4>
                  <p class="font-header text-lg uppercase">MIT STS Program</p>
                </div>
                <div class="p-4 bg-[var(--sweet-peony)]/10 border-l-4 border-[var(--sweet-peony)]">
                  <h4 class="font-mono text-xs uppercase font-bold">Focus</h4>
                  <p class="font-header text-lg uppercase">Black Tech Ed</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Writing Page -->
        <section
          v-else-if="currentPage === 'writing'"
          key="writing"
          class="p-6 md:p-12 max-w-7xl mx-auto"
        >
          <h2 class="font-header text-5xl font-black uppercase mb-12 flex items-center gap-4">
            <span class="text-[var(--burnt-peach)]">Creative</span>
            <Sparkles class="text-[var(--sky-surge)]" />
            Archives
          </h2>
    ...
    <footer class="p-8 border-t-2 border-[var(--blue-slate)] bg-[var(--white-smoke)]">
      <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div class="flex gap-6">
          <a
            href="#"
            class="text-[var(--blue-slate)] hover:text-[var(--sweet-peony)] transition-colors"
          >
            <Twitter />
          </a>
          <a
